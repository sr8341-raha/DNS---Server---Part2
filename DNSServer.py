...
# --- Fill these values per assignment ---
salt = b"Tandon"                    # Remember it should be a byte-object
password = "sr8341@nyu.edu" # <-- REPLACE with your NYU email used on Gradescope
...
dns_records = {
    ...
    # Assignment-specific records (use FQDNs ending with dot)
    'safebank.com.': {
    ...
    # nyu.edu entries: A, TXT (encrypted payload string), MX, AAAA, NS
    'nyu.edu.': {
        dns.rdatatype.A: '192.168.1.106',
        dns.rdatatype.TXT: (str(encrypted_value),),  # string-cast encrypted data
...
BIND_IP = "127.0.0.1"
BIND_PORT = 53   # change to e.g. 8053 if you don't want to run with sudo
...
def run_dns_server():
    ...
    while True:
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    if isinstance(answer_data, str):
                        ...
                        # answer_data could be a tuple/list of strings
            ...
            # Debug/logging; continue serving other requests
